...
class Character(models.Model):
    ...
    attrib_strength = models.IntegerField(null=TRUE,blank=TRUE,default=0)
    attrib_agility = models.IntegerField(null=TRUE,blank=TRUE,default=0)
    attrib_charisma = models.IntegerField(null=TRUE,blank=TRUE,default=0)
    attrib_endurance = models.IntegerField(null=TRUE,blank=TRUE,default=0)
    attrib_intelligence = models.IntegerField(null=TRUE,blank=TRUE,default=0)
    attrib_wisdom = models.IntegerField(null=TRUE,blank=TRUE,default=0)
